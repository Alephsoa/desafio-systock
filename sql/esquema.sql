-- Script para criar as tabelas do desafio técnico
-- Inclui correções no esquema e tabela adicional de produtos

-- Tabela produtos (adicionada para consistência)
...
-- Tabela entradas_mercadoria (corrigida com ordem_compra)
